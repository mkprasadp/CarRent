...
const Banner = () => {
  return (
    <div className='flex flel-col md:flex-row md:items-start items-center
    ...
    max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>
      ...
      <div className='text-white'>
        ...
        <p className='max-w-130'>We take care of insurance, driver verification and secure payments — so 
          you can earn passive income, stress-free.</p>
