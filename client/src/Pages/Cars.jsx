  ...
  return (
    <div>
      <div className='flex flex-col items-center py-20 bg-light max-md:px-4'>
        <Title title="Avaliable Cars" subTitle='Browse our selection of premium vehicles available for your next adventure'/>
      ...
      <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-10'>
        ...
        <div className='grid grid-cols-1 sm:grids-cols-2 lg:grid-cols-3 gap-8 mt-4
